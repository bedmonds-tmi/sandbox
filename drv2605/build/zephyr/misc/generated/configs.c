...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TI_DRV2605_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAPTICS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAPTICS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAPTICS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAPTICS_INIT_PRIORITY, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAPTICS_DRV2605, 1);
